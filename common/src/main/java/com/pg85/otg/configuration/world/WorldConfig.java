...
public class WorldConfig extends ConfigFile {
	...
	protected void writeConfigSettings (SettingsMap writer) {
		...
		writer.putSetting (WorldStandardValues.DIMENSIONS, this.dimensions,
			"Dimensions that should be loaded for this world at world creation. If ALL_WORLDS is present, all worlds without an existing folder will inherit that one. A world directory of the same name must be present in mods/OpenTerrainGenerator/" + PluginStandardValues.PresetsDirectoryName + "/");
