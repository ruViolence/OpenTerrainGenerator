	...
	public static void setup()
	{
		if (FMLEnvironment.dist == Dist.CLIENT)
		{
			...
			BiomeColors.GRASS_COLOR_RESOLVER = (biome, posX, posZ) ->
			{
				...
				if (key == null)
				{
					return grassColorResolver.getColor(biome, posX, posZ); // todo ?
				}
			...
			BiomeColors.FOLIAGE_COLOR_RESOLVER = (biome, posX, posZ) ->
			{
				...
				if (key == null)
				{
					return foliageColorResolver.getColor(biome, posX, posZ); // todo ?
				}
			...
			BiomeColors.WATER_COLOR_RESOLVER = (biome, posX, posZ) ->
			{
				...
				if (key == null)
				{
					return waterColorResolver.getColor(biome, posX, posZ); // todo ?
				}
